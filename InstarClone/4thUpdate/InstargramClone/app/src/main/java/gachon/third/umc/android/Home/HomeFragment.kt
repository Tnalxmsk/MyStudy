...
class HomeFragment: Fragment() {
    ...
    private fun applyStoryData() {
        ...
        dataStoryList.apply {
            add(DataStory("내 스토리", R.drawable.ic_profile_default,1))
            add(DataStory("name1", R.drawable.ic_profile_default, 2))
            add(DataStory("name2", R.drawable.ic_profile_default, 2))
            add(DataStory("name3", R.drawable.ic_profile_default, 2))
            add(DataStory("name4", R.drawable.ic_profile_default, 2))
            add(DataStory("name5", R.drawable.ic_profile_default, 2))
            add(DataStory("name6", R.drawable.ic_profile_default, 2))
            add(DataStory("name7", R.drawable.ic_profile_default, 2))
            add(DataStory("name8", R.drawable.ic_profile_default, 2))
            add(DataStory("name9", R.drawable.ic_profile_default, 2))
            add(DataStory("name10", R.drawable.ic_profile_default, 2))
        }
    }
